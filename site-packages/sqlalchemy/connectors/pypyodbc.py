...
class pypyodbcConnector(Connector):
    driver = 'pypyodbc'

    supports_sane_multi_rowcount = False

    if util.py2k:
        # pypyodbc unicode is broken on UCS-4 builds
    ...
    def __init__(self, supports_unicode_binds=None, **kw):
        super(pypyodbcConnector, self).__init__(**kw)
    ...
    def create_connect_args(self, url):
        ...
        if 'odbc_connect' in keys:
            ...
            if dsn_connection:
                ...
                connectors = []
                driver = keys.pop('driver', self.pypyodbc_driver_name)
                if driver is None:
                    util.warn(
                        "No driver name specified; "
                        "this is expected by pypyodbc when using "
    ...
    def initialize(self, connection):
        ...
        _sql_driver_name = dbapi_con.getinfo(pypyodbc.SQL_DRIVER_NAME)
        ...
        super(pypyodbcConnector, self).initialize(connection)
